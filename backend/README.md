...
## Project Structure
    ...
    ├── projectinviteapp_de_33274  # Django project configurations
...
1. Clone this repo and `cd projectinviteapp_de_33274`
...
2. Clone this repo and `cd projectinviteapp_de_33274`
